...
client = OpenAI(
    api_key="sk-fastgpt",
    base_url="http://direct.virtaicloud.com:45115/v1/"
)
...
vn = MyVanna(client=client,config={"model": "/gemini/pretrain/Qwen2-7B-Instruct",})   #chatglm2-6b
#vn.connect_to_sqlite(host='121.55.77.41', dbname='postgres', user='username', password='password', port=5432)
vn.connect_to_postgres(host='0.0.0.0', dbname='postgres', user='username', password='password', port=5432)
vn.max_tokens = 800
vn.temperature = 0.5
